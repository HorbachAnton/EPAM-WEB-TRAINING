    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
      ...
      <html lang="en">
        ...
        <body>
          ...
          <fmt:message bundle="${loc}" key="locale.pharmacist_page.prescription_id" var="prescription_id"/>
          ...
          <fmt:message bundle="${loc}" key="locale.pharmacist_page.medicine_name" var="medicine_name"/>
            ...
            <div class="row d-flex align-items-center justify-content-center">
              <c:forEach var="count" begin="0" end="${pages_number}">
                <form class="text-center" action="contoller" method="post">
                  <input type="hidden" name="command" value="choose_pharmacist_page"/>
