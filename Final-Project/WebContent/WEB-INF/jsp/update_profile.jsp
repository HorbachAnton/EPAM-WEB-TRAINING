  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
    ...
    <html lang="en" dir="ltr">
      ...
      <body>
        ...
        <fmt:message bundle="${loc}" key="locale.update_profile.note_message" var="note_message"/>
        <fmt:message bundle="${loc}" key="locale.update_profile.note_description" var="note_description"/>
        <fmt:message bundle="${loc}" key="locale.update_profile.why_message" var="why_message"/>
        <fmt:message bundle="${loc}" key="locale.update_profile.why_description" var="why_description"/>
              ...
              <div class="col-sm-4 border border-secondary rounded-lg registration" style="background:cornsilk;">
                <form class="text-center" action="contoller" method="post">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">${enter_first_name}</label>
                    <input type="text" name="first_name" class="form-control" placeholder="Enter your first name" required="required"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">${enter_second_name}</label>
                    <input type="text" name="second_name" class="form-control" placeholder="Enter your second name" required="required"/>
                  </div>
